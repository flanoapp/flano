...
const LikedScreen = ({ navigation }) => {
    ...
    const { getLikedObjects, toggleLiked, currentlyLiked } = useLikedList();
    const { getCurrentUserLocation, currentUserLocation, userLocationErrorMessage } = useLocation();

    useEffect(() => {
        getLikedObjects((array: Array<string>) =>
        ...
        listData: objectListResult.map(o =>
            Object.assign(
                {},
                {
                    ...o,
                    icon: 'heart',
                    isIconSolid: currentlyLiked.includes(o.objectId),
                    pressIcon: () => toggleLiked(o.objectId, toggleLikeObject),
                },
            ),
...
export default withNavigation(LikedScreen);
